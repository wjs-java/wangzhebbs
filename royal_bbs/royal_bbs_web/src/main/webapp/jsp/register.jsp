...
<div class="hm-body hm-body-bgc">
    <div class="hm-inner">
        <div class="reg-box">
            ...
            <div class="reg-info">
                <form action="${pageContext.request.contextPath}/user/saveRegister.do" method="post" id="userRegistered">
                    <ul>
                        <li>
                            <div class="reg-l">
                            ...
                            <span class="tips" id="name">用户名必须是由英文、数字、下划线组成</span>
                        </li>
                        <li>
                            <div class="reg-l">
                            ...
                            <span class="tips" id="password">密码长度必须6~10位的英文或数字</span>
                        </li>
                        <li class="no-tips">
